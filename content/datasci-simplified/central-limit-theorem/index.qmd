...
kable(head(sample_proportions, 5), "html") |>
  kable_styling(font_size = 20)
...
```{r}
#| echo: true
standard_errors = tibble(sample_size = size, standard_error = sd(sample_proportions$proportion))
...
grid.arrange(p10, p20, p50, p100, ncol=1)
```
